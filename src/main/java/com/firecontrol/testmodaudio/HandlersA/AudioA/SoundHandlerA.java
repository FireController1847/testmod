...
public class SoundHandlerA {

	public static final SoundA MISSING_SOUND = new SoundA("meta:missing_sound", 1.0F, 1.0F, 1, SoundA.Type.FILE, false);
			...
			case SOUND_EVENT:
				isoundeventaccessor = new ISoundEventAccessor<Sound>() {
					public int getWeight() {
						SoundEventAccessor soundeventaccessor1 = (SoundEventAccessor) SoundHandlerA.this.soundRegistry
	 ...
	 * Play a sound
	 */
	public void playSound(ISoundA sound) {
	...
	public void stopSound(ISoundA soundIn) {
